...
namespace backend.Data.Migrations
{
    ...
    [Migration("20260919151237_ConvertQuizToMultipleChoice")]
    partial class ConvertQuizToMultipleChoice
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("game_quiz_rounds", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_game_quiz_rounds_close_semantics", "((status = 'open') AND closed_at_utc IS NULL) OR ((status IN ('closed','skipped')) AND closed_at_utc IS NOT NULL)");
                            ...
                            t.HasCheckConstraint("ck_game_quiz_rounds_status_allowed", "status IN ('open','closed','skipped')");
            ...
            modelBuilder.Entity("backend.Data.Entities.GameQuizSubmission", b =>
                {
                    ...
                    b.HasIndex("GameId", "QuizRoundId")
                        .HasDatabaseName("ix_game_quiz_submissions_game_id_quiz_round_id");

                    b.HasIndex("QuizRoundId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_game_quiz_submissions_quiz_round_id_user_id");
                    ...
                    b.ToTable("game_team_members", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("ck_game_team_members_ready_semantics", "(ready_at_utc IS NULL OR ready_at_utc >= joined_at_utc) AND (left_at_utc IS NULL OR ready_at_utc IS NULL)");
                        });
                });
            ...
            modelBuilder.Entity("backend.Data.Entities.GameQuizSubmission", b =>
                {
                    ...
                    b.HasOne("backend.Data.Entities.GameQuizRound", "QuizRound")
                        ...
                        .HasForeignKey("GameId", "QuizRoundId")
                        .HasPrincipalKey("GameId", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_quiz_submissions_round_same_game");
