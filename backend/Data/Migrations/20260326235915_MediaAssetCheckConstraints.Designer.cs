...
namespace backend.Data.Migrations
{
    ...
    [Migration("20260326235915_MediaAssetCheckConstraints")]
    partial class MediaAssetCheckConstraints
    {
            ...
            modelBuilder.Entity("backend.Data.Entities.Game", b =>
                {
                    ...
                    b.ToTable("games", null, t =>
                        {
                            t.HasCheckConstraint("CK_games_finishedat_semantics", "((\"Status\" IN ('draft','active')) AND \"FinishedAtUtc\" IS NULL) OR ((\"Status\" = 'finished') AND \"FinishedAtUtc\" IS NOT NULL)");

                            t.HasCheckConstraint("CK_games_status_allowed", "\"Status\" IN ('draft','active','finished')");
                        });
                });
