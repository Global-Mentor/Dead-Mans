...
### Twitch Bot и доставка викторины
...
- `twitch_quiz_connections` - общие OAuth grants бота (`TwitchBotConnection`), не только викторины. Историческое имя таблицы сохранено. Переподключение
