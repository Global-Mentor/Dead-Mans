const translations = {
  en: {
    ...
    validation: {
      ...
      answerLimit: 'No more than 10 answer variants.',
      duplicateAnswers: 'This answer variant is already added.',
      correctAnswer: 'Select exactly one correct answer.',
    ...
    questions: {
      ...
      fields: {
        ...
        answersHint:
          'The first answer is correct. Players will see the options in a shuffled order.',
        answerCount: '{{count}} / {{max}} options',
        answers: 'Answers',
        answerAlternative: 'Incorrect option {{number}}',
        addAnswer: 'Add option',
        removeAnswer: 'Remove incorrect option {{number}}',
        reward: 'Reward',
        priority: 'Priority',
  ...
  ru: {
    ...
    validation: {
      ...
      answerLimit: 'Не более 10 вариантов ответа.',
      duplicateAnswers: 'Такой вариант ответа уже добавлен.',
      correctAnswer: 'Выберите ровно один правильный ответ.',
    ...
    questions: {
      ...
      fields: {
        ...
        removeAnswer: 'Удалить неверный вариант {{number}}',
        reward: 'Награда',
        priority: 'Приоритет',
  ...
  uk: {
    ...
    validation: {
      ...
      answerLimit: 'Не більше 10 варіантів відповіді.',
      duplicateAnswers: 'Такий варіант відповіді вже додано.',
      correctAnswer: 'Виберіть рівно одну правильну відповідь.',
    ...
    questions: {
      ...
      fields: {
        ...
        addAnswer: 'Додати варіант',
        removeAnswer: 'Видалити неправильний варіант {{number}}',
        reward: 'Нагорода',
        priority: 'Пріоритет',
  ...
  pl: {
    ...
    validation: {
      ...
      tooLong: 'To pole jest zbyt długie.',
      answerLimit: 'Nie więcej niż 10 wariantów odpowiedzi.',
      duplicateAnswers: 'Ten wariant odpowiedzi jest już dodany.',
      correctAnswer: 'Wybierz dokładnie jedną poprawną odpowiedź.',
    ...
    questions: {
      ...
      fields: {
        ...
        answersHint: 'Pierwsza odpowiedź jest poprawna. Gracze zobaczą opcje w losowej kolejności.',
        answerCount: '{{count}} / {{max}} opcji',
        answers: 'Odpowiedzi',
        answerAlternative: 'Niepoprawna opcja {{number}}',
        addAnswer: 'Dodaj opcję',
        removeAnswer: 'Usuń niepoprawną opcję {{number}}',
        reward: 'Nagroda',
        priority: 'Priorytet',
