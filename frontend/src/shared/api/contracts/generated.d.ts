...
export interface paths {
    ...
    "/game/registration/my-team/readiness": {
        ...
        options?: never;
        head?: never;
        patch: operations["updateMyRegistrationReadiness"];
        trace?: never;
    };
    ...
    "/game/registration/my-team/disband-request": {
        ...
        delete: operations["cancelMyRegistrationTeamDisbandRequest"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
...
export interface components {
    schemas: {
        ...
        UpdateRegistrationReadinessRequestDto: {
            isReady: boolean;
        };
...
export interface operations {
    ...
    updateMyRegistrationReadiness: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["UpdateRegistrationReadinessRequestDto"];
            };
        };
        responses: {
            /** @description Current player readiness updated for the forming team */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Missing or invalid isReady boolean */
            400: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Team is locked, unnamed, or not full */
            409: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    cancelMyRegistrationTeamDisbandRequest: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        requestBody?: never;
        responses: {
            /** @description Disband request withdrawn; team remains confirmed */
            200: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description Only the author may withdraw a pending disband request */
            403: {
                headers: {
                    [name: string]: unknown;
                };
            ...
            /** @description The team is no longer confirmed */
            409: {
                headers: {
                    [name: string]: unknown;
                };
